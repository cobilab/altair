...
gnuplot << EOF
    ...
    plot ".NCDFiltered.txt" using 1:2 title '  w=$W1' with lines ls 1, ".AvgNCDProfile.txt" using 1:2 title '  Average of first $headsize bases' with lines ls 3, ".NCDFiltered2.txt" using 1:2 title '  w=$W2' with lines ls 2 #, ".NCDFiltered3.txt" using 1:2 title '  w=$W3' with lines ls 3,
EOF
#
